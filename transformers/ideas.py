...
16. Разные постпроцессоры. (Их можно в принципе вынести в отдельный модуль)
    Например постпроцессор, который добавляет инфу о трафике
...
21. Объединять одинаковые адреса и всякий такой мусор
22. MDVRP2TSPTransformer — Та же идея. Через 1 вектор?
