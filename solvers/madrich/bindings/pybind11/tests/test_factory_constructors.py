...
def test_multiple_inheritance():
    ...
    a = MITest()
    assert m.TestFactory1.amounts.fget(a) == "33"
    assert m.TestFactory2.amounts.fget(a) == "(empty2)"
